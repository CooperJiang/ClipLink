    ...
    <AnimatedModal isOpen={isOpen} onClose={onClose}>
      <div className="flex justify-between items-center border-b border-gray-200 p-4">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-xl font-semibold">ClipLink 使用指南</h2>
        </div>
      ...
      <div className="p-6 overflow-y-auto flex-1">
        <div className="space-y-6">
          <section>
            <h3 className="text-lg font-semibold mb-2">什么是 ClipLink?</h3>
          ...
          <section>
            <h3 className="text-lg font-semibold mb-2">为什么需要 ClipLink?</h3>
            <p className="text-gray-700 mb-2">
          ...
          <section>
            <h3 className="text-lg font-semibold mb-2">如何使用 ClipLink?</h3>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 text-gray-700 space-y-1">
              <li><strong className="text-red-600">重要：</strong>为确保剪贴板权限正常获取，请确保通过 <strong>HTTPS</strong> 协议访问</li>
          ...
          <section>
            <h3 className="text-lg font-semibold mb-2">即将推出的功能</h3>
            <ul className="list-disc pl-5 text-gray-700 space-y-1">
